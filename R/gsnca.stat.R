...
#'
#' @export
#' @seealso [gsnca.p()] for the external function that calls on the current function and returns permutation p-statistic.
#' @examples
#' data(BRCA)
#' N <- ncol(BRCA)
#' n1 <- floor(N/2)
...
gsnca.stat <- function(objt1,objt2,cor.method='pearson') {
